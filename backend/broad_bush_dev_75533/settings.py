"""
Django settings for broad_bush_dev_75533 project.
...
ROOT_URLCONF = 'broad_bush_dev_75533.urls'
...
WSGI_APPLICATION = 'broad_bush_dev_75533.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "broad_bush_dev_75533 API",
    "DESCRIPTION": "API documentation for broad_bush_dev_75533 App",
    "VERSION": "v1",
}
